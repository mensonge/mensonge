...
public class DrawXYGraph extends JFrame
{
	...
	public DrawXYGraph(String applicationTitle, String chartTitle, XYDataset xyDataset)
	{
		super(applicationTitle);
		JFreeChart chart = ChartFactory.createXYLineChart(chartTitle, "Abscisse", "Ordonnée", xyDataset,
	...
	public DrawXYGraph(String applicationTitle, String chartTitle)
	{
		super(applicationTitle);
